...
public class DBAdapterUsuario {
	...
	DbHelperUsuario.TELEFONE, DbHelperUsuario.SENHA};
	
	public DBAdapterUsuario(Context context) {          
		dbHelper = new DbHelperUsuario(context);
	}
	
	public Usuario createUsuario(String nome, String cpf, String email, String telefone, String senha) { 
	...
	public void createTable(){
		database.rawQuery("create table usuario (id integer primary key autoincrement, nome text not null,"
				+ " cpf text not null, email text not null, telefone text not null, senha text not null);", null); 
	}
